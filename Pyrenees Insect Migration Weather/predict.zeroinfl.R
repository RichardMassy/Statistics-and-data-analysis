...
predictSE_short.zeroinfl = function(object,newdata,MC=1000,level=.95,na.action=na.pass,...){
  ...
  return(list(rval,out))
}


predictSE.zeroinfl <- function(object, newdata, type = c("response", "prob"),
